 ...
 */
public class FeedItemAdapter_Year extends ParseQueryAdapter<FeedItem> {

    public FeedItemAdapter_Year(Context context){
        ...
        super(context, new QueryFactory<FeedItem>() {
            ...
            public ParseQuery<FeedItem> create() {
                ...
                query.whereContains("timePosted",(""+ Calendar.getInstance().get(Calendar.YEAR)));
